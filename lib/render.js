...
// Adsterra Popunder & Social Bar (Dipasang global di Layout)
...
// Banner Atas: 728x90 (Desktop) & 320x50 (Mobile)
...
// Banner Samping: 160x600 (Desktop)
function sideBannerAd() {
  return `
    <div class="ad-slot ad-desktop-only">
      <script>
        atOptions = {
          'key' : '25247fde261d8f76e06b91b9d74945f4',
          'format' : 'iframe',
          'height' : 600,
          'width' : 160,
          'params' : {}
...
// Banner Tambahan 468x60
function banner468x60Ad() {
  return `
    <div class="ad-slot">
      <script>
        atOptions = {
...
<header>
  <div class="header-inner">
    <a class="logo" href="/movie">Doo<span>Nung</span>4K</a>
    <nav class="tabs">
...
module.exports = { head, layout, posterCard, genreRow, trailerBlock, castGrid, similarGrid, watchButton, escapeHtml, movieJsonLd, tvJsonLd, topBannerAd, sideBannerAd, nativeBannerAd, banner468x60Ad, DEFAULT_TITLE, DEFAULT_DESC, SITE_NAME };
